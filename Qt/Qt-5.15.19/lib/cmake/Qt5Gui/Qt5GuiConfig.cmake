...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.19"
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.19/QtGui"
    )
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES accessibility;opengles2;dynamicgl;angle;combined-angle-lib;opengl;openvg;opengles3;opengles31;opengles32;system-textmarkdownreader;textmarkdownwriter;textodfwriter;vulkan)
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 accessibility;opengles2;dynamicgl;angle;combined-angle-lib;opengl;openvg;opengles3;opengles31;opengles32;system-textmarkdownreader;textmarkdownwriter;textodfwriter;vulkan)
    set_property(TARGET Qt5::Gui
    ...
    _populate_Gui_target_properties(RELEASE "Qt5Gui.lib" "" TRUE)



    _populate_Gui_target_properties(DEBUG "Qt5Guid.lib" "" TRUE)
