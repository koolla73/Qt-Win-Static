...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.19"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.19/QtNetwork"
    )
    ...
    _populate_Network_target_properties(RELEASE "Qt5Network.lib" "" TRUE)



    _populate_Network_target_properties(DEBUG "Qt5Networkd.lib" "" TRUE)
