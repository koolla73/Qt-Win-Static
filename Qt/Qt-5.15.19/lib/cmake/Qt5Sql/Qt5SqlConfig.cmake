...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.19"
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.19/QtSql"
    )
    ...
    _populate_Sql_target_properties(RELEASE "Qt5Sql.lib" "" TRUE)



    _populate_Sql_target_properties(DEBUG "Qt5Sqld.lib" "" TRUE)
