...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/QtTest/5.15.19"
        "${_qt5Test_install_prefix}/include/QtTest/5.15.19/QtTest"
    )
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test.lib" "" TRUE)



    _populate_Test_target_properties(DEBUG "Qt5Testd.lib" "" TRUE)
